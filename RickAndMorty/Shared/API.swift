  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Character: GraphQLSelectionSet {
      ...
      public struct Result: GraphQLSelectionSet {
        ...
        public init(image: String? = nil, id: GraphQLID? = nil, name: String? = nil, location: Location? = nil) {
          self.init(unsafeResultMap: ["__typename": "Character", "image": image, "id": id, "name": name, "location": location.flatMap { (value: Location) -> ResultMap in value.resultMap }])
        }
